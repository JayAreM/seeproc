<?php
	...
	if(isset($_COOKIE['airDefFontSize'])){
		$defFontSize = $_COOKIE['airDefFontSize'].'px';
	}else{
		$defFontSize = '14px';
	}
...
<script>
	...
	function setInv(invs) {
	    ...
	    var disInvNo = document.getElementsByClassName('disInvNo');
		...
		for(var i = 0; i < len; i++){
			...
			if(div.scrollHeight > div.offsetHeight){
				...
				var descX = desc.split("\n");
			 	...
			 	tableBody.innerHTML +="<tr class='rowHover' id='rowNum"+num+"' style='font-size:"+defFontSize+";'><td style='padding: 0px 12px; font-size:"+defFontSize+";' class = 'tdData' id='itemNum"+i+"'>" +  num + "</td><td class = 'tdData'  style='padding: 0px 12px; font-size:"+defFontSize+";'>" + j.unit[i] +"</td><td id='desc"+j.poId[i]+"' class = 'tdData' style = 'white-space: pre-line; word-wrap: break-word; font-size:"+defFontSize+";'>" + desc + "</td><td class = 'tdData' style = 'padding: 0px 12px; border-right: 0px; font-size:"+defFontSize+";' >" +qty+"</td></tr>";
	...
	function header(office,supplier,prNumber,tn){
		var sheet = '<tr><td colspan = "6">';
			...
			sheet += '					  <table border="0" style="margin: 0px auto; width: 100%; text-align: center;">'
										...
										+'			<div class="revevCont">DocTrack '+year+'</div>'
										+'		</td>'
										+'	</tr>'
										+'</table>'
			sheet += '				</td>';
			...
			sheet +=					'<table border="0" style="font-size: 13px; width: 100%; padding: 10px 0px 0px 0px; border-spacing:0px;">';
			sheet +=						'<tr>'
			...
			sheet +=						'</tr>'
			sheet +=						'<tr>'
			sheet +=							'<td valign="bottom" style="">PO No.</td>'
			sheet +=							'<td valign="bottom">'
			sheet +=								'<input disabled style="font-weight: bold; border: 0px; border-bottom: 1px solid black; width: 120px; padding-left: 3px; " value="'+prNumber+'">'
			sheet +=							'</td>'
			sheet +=							'<td valign="bottom" style="padding:0px; padding-left:2px;"></td>'
			...
			sheet +=								'<div class="disInvNo" style="padding-left: 3px; border: 0px; border-bottom: 1px solid black; width: 310px; word-wrap:break-word;"></div>'
			sheet +=							'</td>'
			sheet +=							'<td valign="bottom" style="padding:0px;"></td>'
			sheet +=							'<td valign="bottom">AR No.</td>'
			sheet +=							'<td valign="bottom">'
			sheet +=								'<input disabled name="disAirNo" style="border: 0px; border-bottom: 1px solid black; width: 140px;">'
			sheet +=							'</td>'
			sheet +=						'</tr>'
			sheet +=						'<tr>'
			sheet +=							'<td>Date</td>'
			sheet +=							'<td><input disabled name="poDate" style="padding-left: 3px; border: 0px; width: 120px;" value="'+invPoDate+'"></td>'
			sheet +=							'<td valign="bottom" style="padding:0px;"></td>'
			sheet +=							'<td>Date</td>'
			sheet +=							'<td colspan="4"><input disabled name="disInvDate" style="padding-left: 3px; border: 0px; width: 100%;"></td>'
			// sheet +=							'<td><input disabled name="disInvDate" style="padding-left: 3px; border: 0px; width: 200px;"></td>'
			// sheet +=							'<td valign="bottom" style="padding:0px;"></td>'
			// sheet +=							'<td></td>'
			// sheet +=							'<td></td>'
			sheet +=						'</tr>'
	...
	function quarter(quart,category,categoryName){
		var  sheet = '<tr>';
		      ...
		      sheet += '<td class = "tdData1"></td>';
		      sheet += '<td class = "tdData1" style = "text-align:center;font-weight:bold;padding:8px 0px;font-size:14px; font-size:'+defFontSize+';">' + category + ' - ' + categoryName  + '</td>';
	...
	function set(){
		...
		var setINV = document.getElementsByClassName('disInvNo');
	...
	function editorSet(){
		...
		sheet  +="<div id='editorContainer' class='editorContainer' style='border: 0px; min-height: 620px;'>" 
				+"	<table border='0' cellspacing='0' style='padding: 0px; border-spacing: 0px; font-family:Arial;'>"
				
				+"		<tr>"
				+"			<td style='background-color:transparent; padding:0px; padding-bottom:3px;'>"
				+"				<div style='display: inline-block;'>"
				+"					<table border='0' style='border-spacing:0px; padding:0px; font-size:14px;'>"
				+"						<tr>"
				+"							<td style='padding: 0px;'><span id='col0' style='' class='floatingTab slctBtn' onclick='changeCol(this)'>AIR Entries</span></td>"
				+"							<td style='padding: 0px;'><span id='col1' style='' class='floatingTab' onclick='changeCol(this)'>Replacements</span></td>"
				+"							<td style='padding: 0px;'><span id='col2' style='' class='floatingTab' onclick='changeCol(this)'>Attachments</span></td>"
				+"						</tr>"
				+"					</table>"
				+"				</div>"
				...
				+"				<table border='0' style='padding: 10px; font-size:14px;'>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Label</td>"
				+"						<td><input class='text3' style='text-align:left; margin-top: 20px;' id='FormAirInvTit' value='"+invTitle+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Invoice No.</td>"
				+"						<td><input class='text3' style='margin-top: 5px; text-align:left;' id='FormAirINV' value='"+invNo+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Invoice Date</td>"
				+"						<td><input class='text3' style='margin-top: 5px; text-align:left;' id='FormAirDate' value='"+invDate+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>PO Date</td>"
				+"						<td><input class='text3' style='margin-top: 5px; text-align:left;' id='FormAirPoDate' value='"+invPoDate+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px;' valign='middle'>Acceptance</td>"
				+"						<td>"
				+"							<table>"
				+"								<tr>"
				+"									<td style='text-align: right;'><input name='accChk' value='1' class='regular-checkbox big-checkbox' type='checkbox' onclick='checkEditorSet(1)'></td>"
				+"									<td><label for='compCheck' style='margin-top: 10px; display: inline-block;'>Complete</label></td>"
				+"								</tr>"
				+"								<tr>"
				+"									<td style='text-align: right;'><input name='accChk' value='2' class='regular-checkbox big-checkbox' type='checkbox' onclick='checkEditorSet(2)'></td>"
				+"									<td><label for='partCheck' style='margin-top: 10px; display: inline-block;'>Partial</label></td>"
				+"								</tr>"
				+"							</table>"
				+"						</td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Received by</td>"
				+"						<td><input class='text3' style='margin-top: 20px; text-align:left; background-color: rgb(216, 224, 228);' id='FormAirRecBy' value='"+invRecBy+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Title</td>"
				+"						<td><input class='text3' style='margin-top: -2px; text-align:left; background-color: rgb(216, 224, 228);' id='FormAirPOR' value='"+invAccPos+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Date</td>"
				+"						<td><input class='text3' style='margin-top: -2px; text-align:left; background-color: rgb(216, 224, 228);' id='FormAirDateRec' value='"+invAccDate+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Inspected by</td>"
				+"						<td><input class='text3' style='margin-top: 5px; text-align:left; background-color: rgb(216, 224, 228);' id='FormAirInsBy' value='"+invInsBy+"'></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td></td>"
				+"						<td style='padding-top: 10px; padding-bottom: 20px; text-align: center;'><span class='setBtn' style='width:50px;' onclick='set()'>Set</span></td>"
				+"					</tr>"
				+"				</table>"

				+"				<table border='0' style='display: none; padding: 10px; background-color: white; font-size:14px;'>"
				+"					<tr>"
				...
				+"					</tr>"
				+"					<tr>"
				+"						<td style='padding-left: 5px;' class='' colspan='2'>Description</td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='' colspan='2'>"
				+"							<div style='overflow-y: auto; max-height: 250px; max-width: 434px; min-width: 434px; padding: 2px; margin-bottom: 10px;'>"
				+"								<div id='AIRDesc' class='oldArDesc' style='max-width: 385px; min-width: 350px; font-weight: bold; padding-left: 30px; padding-top: 10px;'></div>"
				+"							</div>"
				+"						</td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='padding-left: 5px;' class='' colspan='2'>Replacement</td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style='' colspan='2'><textarea id='AIRDesc1' class='newArDesc' placeholder='Type here' style='width: 434px; padding-left: 30px; padding-top: 10px;'></textarea></td>"
				+"					</tr>"
				+"					<tr>"
				+"						<td style=' text-align: center; padding-top: 5px; padding-bottom: 20px;' colspan='2'><span class='setBtn' onclick='updateAir()'>Update</span></td>"
				+"					</tr>"
				+"				</table>"

				+"				<table border='0' style='display: none; padding: 10px; background-color: white;'>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px; padding-bottom: 6px;' valign='bottom'>Classification</td>"
				...
				+"					</tr>"
				+"					<tr>"
				+"						<td style='text-align: right; padding-right: 10px;' valign='bottom'></td>"
				+"						<td>"
				...
				+"					<tr>"
				+"						<td></td>"
				+"						<td style='padding-top: 10px; padding-bottom: 20px; text-align: center;'><span class='setBtn' onclick='uploadFile()'>Upload</span></td>"
				+"					</tr>"
				+"				</table>"
				+"			</td>"
				+"		</tr>"
				+"		<tr>"
				+"			<td style='vertical-align:bottom; font-size:0px; background-color:white; padding:10px;'>"
	...
	function changeFontSize(elemClass, sizeChange) {
		var curFontSize = readCookie('airDefFontSize');
		var fontSize = 0;
		var newFontSize = 0;
		...
		if(curFontSize == -1) {
			...
			setCookie("airDefFontSize", newFontSize, 1);
		}else {
