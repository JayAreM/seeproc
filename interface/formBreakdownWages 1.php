...
<?php
    ...
    if(strlen($ptrs) > 0){
        ...
        if($error == 0){
            ...
            $sheet0 .= "
                        <div class='pHeader1' style='font-size:16px;'>
            ...
            while ($data = $database->fetch_array($result)) {
				...
				if($curHeaderId == "" || $curHeaderId != $headerId){
					...
					$sheet0 .= "	<tr style='background-color:white;'>
										...
										<td colspan='12' style='padding:3px 5px; text-align:left; font-style:italic; font-weight:bold; font-size:12px; letter-spacing:1px; border-bottom:1px dashed silver;'>
											".$period."
										</td>
									</tr>";
                ...
                $sheet0 .= "<td style='font-size:12px; text-align:left; white-space:nowrap;'><span style='display:none;'>".$empnum."</span><span>".utf8_encode(utf8_decode($fullname))."</span></td>
                            ...
                            <td style='font-size:12px;'>".number_format($other, 2)."</td>
...
<head>
    ...
    #tableDoctrackDBFList td:nth-child(9), #tableDoctrackDBFList td:nth-child(13){
