	...
	<table style = "width:100%;background-color:rgb(239, 243, 221);padding:1px;">
		<tr>
			<td  style ="vertical-align:top;">
				<div id = "ppmpLockContainer" style = "border:1px solid silver;min-height:600px;background-color:white;">
							...
							<table style = "margin:0 auto;width:200px;border-spacing:0;padding:10px 20px;background-color:rgb(253, 248, 242);" border = "0">
								...
								<tr>	
									<td  style = "padding-left:20px;padding-top:10px; ">	
										<input value="" type="radio" name="selectTypeFundLockerA" id="opt8"  class="radio1" onclick = "clickLockerFundTypeA(this)"/>
										<label  for="opt8">By Fund</label>
									</td>
								</tr>
								<tr>	
									<td  style = "padding-left:20px;padding-top:10px;padding-bottom:10px; ">	
										<input value="" type="radio" name="selectTypeFundLockerA" id="opt9"  class="radio1" onclick = "clickLockerFundTypeA(this)" />
										<label  for="opt9">By Office</label>
									</td>
								</tr>
					...
					<tr style="background-color: rgb(233, 223, 181);">
						<td  style ="border:1px solid white;border-top: 0;border-bottom: 0;padding-bottom: 10px;" id = "ppmpViewSelectOfficeContainer">
							<table style = "margin:0 auto;width:200px;border-spacing:0;padding:10px 20px;" border = "0">
								...
								<tr>	
									<td  style = "padding-left:20px;padding-top:10px; ">	
										<input value="" type="radio" name="selectType" id="opt1"  class="radio1" onclick = "clickLocker(this)" checked/>
										<label  for="opt1">Office List</label>
									</td>
								</tr>
								<tr>	
									<td  style = "padding-left:20px;padding-top:10px;padding-bottom:10px; ">	
										<input value="" type="radio" name="selectType" id="opt2"  class="radio1" onclick = "clickLocker(this)"/>
										<label  for="opt2">Already Locked</label>
									</td>
								</tr>
								<tr>	
									<td  style = "padding-left:20px; ">	
										<input value="" type="radio" name="selectType" id="opt3"  class="radio1" onclick = "clickLocker(this)"/>
										<label  for="opt3">Still Open</label>
									</td>
								</tr>
							</table>
						</td>
...
<script>
	...
	function loadPPMPlockOffice(type){
		loader();
		var queryString = "?loadPPMPlockOffice=1&type="+ type;
		var container = document.getElementById("ppmpLockContainer");
		ajaxGetAndConcatenate(queryString,processorLink,container,"loadPPMPlockOffice");
	}
	function clickLocker(me){
		var id = me.id;
		if(id  == "opt1"){
			loadPPMPlockOffice(1);
		}else if(id  == "opt2"){
			loadPPMPlockOffice(2);
		}else if(id  == "opt3"){
			loadPPMPlockOffice(3);
		}
	}
	function lockThis(me){
		var v = 0;
		var code = me.id;
		if(me.checked == true  ){
		...
		var queryString = "?lockThis=1&ppmp=" + v + "&code=" + code;
		var container = "";
		ajaxGetAndConcatenate(queryString,processorLink,container,"lockThis");
	}
	function clickLockerFundTypeA(me){
		var id = me.id;
		document.getElementById("opt6").click();
		if(me.id == "opt9"){
