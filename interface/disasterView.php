<?php	
	...
	$legend .= '<tr><td colspan ="2" style ="background-color:rgb(34, 44, 44);border-bottom:1px solid black;text-align:center; color:white;font-size:14px;font-family:oxy;width:140px;">Office Legend</td></tr>';
	while($data = $database->fetch_array($record)){
		$office = $data['Office'];
		$color = $data['Color'];
	...
	$sql = "select x.*,
			...
			y.Remarks as PO_Remarks,y.Remarks1 as PO_Remarks1,
			y.Fund as PO_Fund,
			...
			z.Remarks as PX_Remarks,z.Remarks1 as PX_Remarks1,
			z.Fund as PX_Fund
			
			
			from( SELECT a.Id,a.Office as OfficeCode,a.Name,a.ProjectCost,b.Name as Office,c.Remarks, c.Remarks1, c.TrackingNumber ,c.Status,c.DateModified,c.Amount,c.PR_CategoryCode, c.TotalAmountMultiple,c.Fund,c.DateEncoded,d.Description as Category 
	...
	$sheet .= '<tr style = "color:black;"><td colspan ="100%" style ="text-align:left;font-size:28px; font-family:anton;padding-bottom:20px;">PROCUREMENT PROCESS</td></tr>';
	...
	$sheet .= '<tr  id = "summary2" style ="backgroun1d-color:rgb(32, 44, 48);display:none;">
						<td colspan ="100%" style ="padding-left:20px;text-align:left;color:whi1te;font-size:28px; font-family:anton;padding:10px 0px;">DISASTER PROJECTS
						</td>
					</tr>';				
					...
					if(trim($column['Status']) == $status){
						...
						$sheet .= '					<tr>
														<td style = "text-align:right;" >
															...
															<div onclick = "showSingleNote(this)" style ="cursor:pointer;width:13px;height:13px;display:inline-block;border: 2px solid white; background-color:' . $bulletColor . ';margin-right:-12px;border-radius:50%;margin-top:-35px;box-shadow:5px 0px 10px black;">
														...
														<td style ="text-align:right;padding:5px;">
															<div style = "line-height:13px;">
																...
																if(preg_match("/Pending/",$status)){
																	...
																	if($remarks1){
																		$sheet .= '<table  class ="pendingsTable" style ="width:100%;" border ="0"><tr><td><div class ="pendings" >' . $remarks1 . '</div></td></tr></table>';
																	}
									...
									if($oldPOtn != $poTN){
										...
										$sheet .= '	<tr>
														<td style = "text-align:right;" >
															...
															<div onclick = "showSingleNote(this)" style ="cursor:pointer;width:13px;height:13px;display:inline-block;border: 2px solid rgb(96, 197, 108); background-color:' . $bulletColor . ';margin-right:-12px;border-radius:50%;margin-top:-35px;box-shadow:5px 0px 10px black;">
															</div>
														</td>
													</tr>
													<tr class = "trDetails">
														<td style ="text-align:right;padding:5px;">
															<div style = "line-height:13px;">
																...
																if(preg_match("/Pending/",$poStatus)){
																	...
																	if($poRemarks1){
																		$sheet .= '<table  class ="pendingsTable" style ="width:100%;" border ="0"><tr><td><div class ="pendings" >' . $poRemarks1 . '</div></td></tr></table>';
																	}
																}
												...
												<table style ="float:right;width:100%;font-size:13px;padding-right:17px; margin-bottom:5px;margin-top:1px;color:' . $fontColor . '" border="0">
													<tr>
														<td style = "text-align:right;" >
															...
															<div onclick = "showSingleNote(this)" style ="cursor:pointer;width:13px;height:13px;display:inline-block;border: 2px solid rgb(237, 168, 20); background-color:' . $bulletColor . ';margin-right:-12px;border-radius:50%;margin-top:-35px;box-shadow:5px 0px 10px black;">
															</div>
														...
														<td style ="text-align:right;padding:5px;">
															<div style = "line-height:13px;">
																...
																if(preg_match("/Pending/",$pxStatus)){
																	...
																	if($pxRemarks1){
																		$sheet .= '<table  class ="pendingsTable" style ="width:100%;" border ="0"><tr><td><div class ="pendings" >' . $pxRemarks1 . '</div></td></tr></table>';
																	}
																}
    ...
    if($totalAllcost > 0 ){
		...
		$sheet .= '<tr class = "summary1"><td colspan ="100%" style ="background-color:rgb(32, 44, 48);padding:20px;">
					<table style ="text-align:right;float:right;color:white;font-Size:14px;border-spacing:0;" border ="0">
						<tr>
							<td colspan ="100%" style ="text-align:left;border-bottom:1px solid grey;font-size:28px; font-family:anton;text-shadow:0px 0px 5px black;">PROCESS AVERAGE<span style ="font-family:oswald;letter-spacing:1px;color:silver;font-size:12px;font-weight:normal;"> (calendar days)</span></td>
						</tr>
						<tr>
		...
		$sheet .= '<tr  class = "summary1" style ="background-color:rgb(32, 44, 48);">
							<td colspan ="100%" style ="padding-left:20px;text-align:left;color:white;border-bottom:1px solid grey;font-size:28px; font-family:anton;text-shadow:0px 0px 5px black;">FUND SUMMARY
					...
					<td colspan ="100%" style ="background-color:rgb(19, 21, 28);color:white;" > 
						<table class = "graph" style ="color:white;width:100%;white-space:nowrap;border-spacing:0;" border ="0">
							...
							<tr>
								...
								<td style ="">
									<div style = "height:10px;width:' . $pdPercentCost . '%;background-color:white;"></div>
								</td>
							</tr>
							<tr>
								<td></td>
									...
									<table border ="0">
										<tr>
											<td style = "padding-top:200px;color:red;">';
												if( $prTrustFund > 0 and $prGenFund > 0){
													$sheet .= '<div style = "border-bottom:1px solid brown;padding-bottom:2px;">Trust Fund</div>';
												}
		...
		$sheet .= '<tr  class = "summary1" style ="">
							<td colspan ="100%" style ="padding-top:40px;padding-left:20px;text-align:left;font-size:28px; font-family:anton;color:rgb(32, 44, 48);">FUND DISTRIBUTION
							</td>
						</tr>';	   
						...
						<td colspan ="100%" style = "padding-top:20px;">
							<table border ="0" style ="float:right;">
								<tr>
									...
									<td id = "pieLegend" colspan ="100%" style ="vertical-align:top;padding-top:50px;width:">
		...
		$sheet .= '<tr  class = "summary1" style ="">
							<td colspan ="100%" style ="padding-top:120px;padding-left:20px;text-align:left;font-size:28px; font-family:anton;color:rgb(32, 44, 48);">FUND USAGE
							</td>
						</tr>';	   
...
<script>
	...
	function showSingleNote(me){
		var arr = me.parentNode.parentNode.parentNode.getElementsByClassName("pendingsTable");
		if(arr[0]){
			if(arr[0].style.display.toUpperCase() == "NONE" || arr[0].style.display == ""){
				arr[0].style.display ="table";
			}else{
	...
	function bars(){
		...
		pieTable += "<tr style = 'background: linear-gradient(to left,rgb(41, 80, 30),rgb(44, 77, 102));font-size:14px;color:white;' ><td></td><td></td>" +
						...
						"<td style ='padding:0px 5px;text-align:right;'>Allocation</td>" +
		...
		for(var i = 0; i < arr1.length-1; i++){
			...
			if(poCount > 0){
				pieTable += "<tr style = 'line-height:14px;font-size:14px;letter-spacing:1px;'><td colspan ='4'></td>" +
							...
							"<td style ='text-align:right;padding-left:5px;'><div style ='height:10px;width:300px;background-color:si1lver;'><div style ='height:100%;width:" + percentPO + "%;background-color:" + myColor[i] + ";'></div></div></td>" +
						"</tr>";	
			}
			if(pxCount > 0){
				pieTable += "<tr style = 'line-height:14px;font-size:14px;letter-spacing:1px;'><td colspan ='4'></td>" +
							...
							"<td style ='text-align:right;padding-left:5px;'><div style ='height:10px;width:300px;background-color:si1lver;'><div style ='height:100%;width:" + percentPX + "%;background-color:" + myColor[i] + ";'></div></div></td>" +
						"</tr>";	
			}
			if(pdCount > 0){
				pieTable += "<tr style = 'line-height:14px;font-size:14px;letter-spacing:1px;'><td colspan ='4'></td>" +
							...
							"<td style ='text-align:right;padding-left:5px;'><div style ='height:10px;width:300px;background-color:si1lver;'><div style ='height:100%;width:" + percentPD + "%;background-color:" + myColor[i] + ";'></div></div></td>" +
						"</tr>";	
			}					 
	...
	function showReportOnly(me){
		...
		if(flagReport == 0){
			...
			document.getElementById("summary2").style.display ="table-row";
		}else{
