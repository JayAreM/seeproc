...
<?php
	...
	$sql = "select Adv1,Claimant,NetAmount,DocumentType,PayeeNumber from vouchercurrent where TrackingNumber = '" . $tn ."' limit 1";
...
?>
	...
	<html>
		...
		<body>
			...
			<div id = "mainTable" style = "border:1px solid black;width:770px;height:278px;margin:0 auto; " ondblclick = "checkBG()">
									...
									<td colspan="4" style= "font-size:7px;font-weight: bold;font-size: 14px;vertical-align:top;">
										<table border = "0" style="margin-top: 0px;">
											<tr>
												...
												<td id = "claimant" style="border-bottom: 1px solid black;width:422px;font-size: 12px;font-weight:bold;text-align: center;line-height:12px;vertical-align: bottom;"><?php echo "VAL GALIDO BALANGUE VAL GALIDO BALANGUE VAL GALIDO BALANGUE VAL GALIDO BALANGUE VAL GALIDO BALANGUE"; ?> </td>
												
												<td id = "netNumber" style = "border:1px solid black;width:198px;text-align: center;font-weight: bold;font-size: 14px;padding-bottom: 2px;"><?php echo "999,999,999.00" ?></td>
											</tr>
										</table>
									</td>
								</tr>
	...
	<script>
		...
		function getNet(net){
			...
			var amountWord =  convertWordCurrency(1234567896);
	...
	<table style = "border-spacing: 0px;height:100%;width:740px;">
		<tr>
			<td style = "padding:0;width:12px;padding-left:15px;vertical-align:top;padding-top:55px;display:none1;">
				<div STYLE  = "writing-mode: vertical-rl;transform:scale(-1);padding:0;font-size:8px;letter-spacing:1px;">DOCUMENTARY STAMPSS PAID</div>
			</td>
			<td style = "vertical-align: top;padding-top:5px;">
				<table border ="1" class = "t2"  style = "width:100%;border-spacing:0;">
					<tr>
						<td style= "font-size:7px;width:188px;">ACCOUNT No.</td>
						<td style= "font-size:7px;width:218px;">ACCOUNT NAME</td>
						<td id  = "logo1" rowspan = "2" style = "width:132px;background:url(../images/bcode.png);background-size:83% 65%;background-repeat: no-repeat;font-size:12px;vertical-align:bottom;text-align: right;">Date</td>
						<td style= "font-size:7px;letter-spacing:1px;">CHECK No.</td>
					</tr>
					<tr>
						<td style = "font-size: 13px;vertical-align:top;font-weight: bold;letter-spacing: .2px;">001472-1000-13-<span style ="font-size: 13px;"> GEN.FUND </span>
						...
						<td style = "letter-spacing:3px;font-size:16px;font-weight:bold;vertical-align:top;padding-top:0;  ">0002497776
							<table id = "tableDate" class = "tableDate" border= "0" style = "height: 20px;border-spacing:0;font-size:11px;padding:0;letter-spacing: 0;font-weight: bold;">
								<tr>
									<td><?php echo $today[0]; ?></td>
									<td><?php echo $today[1]; ?></td>
									<td id = "dateSep1"  style="width:10px;">-</td>
						...
						<td colspan="4" style= "font-size:7px;font-weight: bold;font-size: 14px;vertical-align:top;">
							<table border = "0" style="margin-top: 10px;">
								<tr>
									...
									<td id = "claimant" style="border-bottom: 1px solid black;width:422px;font-size: 12px;font-weight:bold;text-align: center;line-height:12px;"><?php echo $claimant; ?> </td>
									<td style = "line-height: 10px;font-size: 14px;font-weight: bold;padding-left:2px;padding-right: 2px;">&#8369;</td>
									<td id = "netNumber" style = "border:1px solid black;width:198px;text-align: center;font-weight: bold;font-size: 14px;"><?php echo number_format($net,2); ?></td>
								</tr>
							</table>
						</td>
					</tr>
					<tr>
						<td colspan="4" style= "font-size:7px;font-weight: bold;font-size: 14px;vertical-align:top;">
							<table border = "0" >
								<tr>
									<td style = "vertical-align:bottom;width:0px;height:33px;font-size: 12px;font-weight: bold; text-align: justify;text-justify: inter-word;line-height: 12px;padding-left:5px;padding-right:5px;">
										PESOS
									</td>
									
									<td  id  = "net" colspan="2" style="vertical-align:bottom;border-bottom: 1px solid black;width:652px;font-size:12px; text-align:center; "></td>
								</tr>
								<tr>
									<td colspan = "3">
										<table border = "0" style = "width:99.5%;margin-top:2px;margin-left: 5px;">
											<tr>
												<td id  = "logo3" rowspan="2" style = "background:url(../images/bank.png);background-size:48px 48px; background-position-y:7px;  background-repeat: no-repeat;padding-left:55px;width:150px;padding-top:16px;padding-bottom: 5px;">
								...
								<tr>
									<td colspan = "3">
										<table border = "0" style = "float:right;margin-top:6px;width:100%;">
											<tr>
												<td id = "advType"  style = "font-size: 10px;padding-left: 80px;">
													 <div >ADV Number : <span style = "font-weight: bold;font-size:12px;letter-spacing: 1px;"><?php echo $adv; ?></span></div>
													 <div><?php echo $type; ?></div>
											...
											<tr>
												<td colspan="4" style = "font-size: 20px;padding-left: 74px;letter-spacing: 3px;padding-top:15px;font-family: check;font-weight: bold;">
													 "1234567891||12340||001472100013" 000
