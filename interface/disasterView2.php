		...
		if($projectView == 0){
			...
			if($col < sizeof($arrayColumnPO)){
				$sheet .= '	<td colspan = "' .  (sizeof($arrayColumnPO)-$col)  . '" style ="text-align:right;"></td>
							<td style ="border-left:1px solid black;background-color:rgb(123, 172, 193);"></td>
							';
			}else{
				$sheet .= '<td style ="border-left:1px solid black;background-color:rgb(123, 172, 193);"></td>';
			}
			...
			if($col < sizeof($arrayColumnPX)){
				$sheet .= '	<td colspan = "' .  (sizeof($arrayColumnPX)-$col)  . '" style ="text-align:right;"></td>
							<td style ="border-left:1px solid silver;background-color:white;"></td>
							';
			}else{
