			...
			<td id = "calendarContainer" style = "vertical-align:top;" colspan="2">
					...
					<table id  ="tableCalendar">
						...
						<tr>
							...
							// strtoupper($status) == "CAO RECEIVED"
							// strtoupper($status) == "CAO ON PROCESS"
							// strtoupper($status) == "ON EVALUATION - ACCOUNTING"
							// strtoupper($status) == "EVALUATED - ACCOUNTING"
							// strtoupper($status) == "CARDED - ACCOUNTING"
							// strtoupper($status) == "SALARY LIST PAYROLL - ACCOUNTING"
							// strtoupper($status) == "SLP CREATED - ACCOUNTING"

							$statusArr =  [ 'CAO Received','On Evaluation - Accounting','Evaluated - Accounting','Carded - Accounting','SLP Created - Accounting','Pending at CAO','Pending Released - CAO','Forwarding Transmittal', 'CAO Released',
								...
								foreach ($statusArr as $stat) {
									...
									if($j ==  1){
										echo "<td rowspan = '12' style = 'background-color:rgb(176, 180, 182);font-family:Oswald;font-size:12px;letter-spacing:1px;font-weight:bold;'>Accounting</td>";
									}else if($j == 13 ){
										...
										echo "<td rowspan = '12' style = 'background-color:rgb(176, 180, 182);font-family:Oswald;font-size:12px;letter-spacing:1px;font-weight:bold;'>Admin</td>";
									}else if($j == 49 ){
