<?php	
		...
		if($flag > 0){
			...
			if($lastName != $name){
				...
				$sheet1 = '<tr class ="summary1"><td class = "summaryTd" colspan ="100%" style ="border-top:1px solid white;border-bottom:1px solid white;
						  	...
						  	<table border ="0" style ="float:right;border-spacing:0;min-width:700px;margin-right:100px;">
						  		<tr>
	...
	if($lastCost > 0){
		...
		$sheet .= '<tr class = "summary1"><td colspan ="100%"  style ="border-top:1px solid white;border-bottom:1px solid white;
								background: linear-gradient(to right, rgb(188, 207, 218) ,rgba(249, 250, 251,.8));padding:20px;padding-right:30px;">
						  	<table border ="0" style ="float:right;border-spacing:0;min-width:700px;margin-right:100px;">
						  		<tr>
						  			<td style ="vertical-align:top;padding:0px 10px;" rowspan ="5"><span style ="background-color:white;padding:2px 5px;border-right:1px solid black;border-bottom:1px solid silver;">' . $oldId . '</span></td>
    ...
    if($totalAllcost > 0 ){
		...
		$sheet .= '<tr class = "summary1">
					<td colspan ="100%" style ="background-color:rgb(19, 21, 28);color:white;padding-top:10px;padding-bottom:20px;" > 
						<table class = "graph" style ="color:white;white-space:nowrap;border-spacing:0;" border ="0">
							<tr style ="font-size:12px;font-family:arial;">
		...
		$sheet .= '<tr class = "summary1">
						<td colspan ="100%">
							<table>
								<tr>
									<td ><span id ="pieData" style ="display:none;">' . $pieProjects . '</span>
										<canvas id="can" width="600" height="600" />
									</td>
									<td id = "pieLegend" colspan ="100%" style ="vertical-align:top;padding-top:90px;">
...
<script>
	...
	function pie(){
		...
		pieTable += "<tr style = 'font-size:12px;font-weight:bold;' ><td></td><td></td><td style ='padding-left:10px;padding-bottom:10px;'>Implementing Office</td><td style ='padding:0px 5px;padding-bottom:10px;'>Projects</td></tr>";
		var sumCount = 0;
		for(var i = 0; i < arr1.length-1; i++){
			...
			labels[i] = i+1;
			pieTable += "<tr><td style = 'text-align:right;font-size:12px;padding:0px 5px;'>" +  (i+1) + "</td><td style = 'padding:2px 15px;background-color:" + myColor[i] + "'></td><td style ='padding-left:10px;'>" + office + "</td><td style ='text-align:center;'>" + count + "</td></tr>";
		}
		pieTable += "<tr style = 'font-size:22px;font-weight:bold;' ><td></td><td></td><td ></td><td style ='padding:0px 5px;text-align:center;padding-top:10px;'><span style = 'border-top:1px solid black;'>" + sumCount + "</span></td></tr>";
