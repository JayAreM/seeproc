...
<div style ="background: linear-gradient(to left, transparent ,rgb(35, 85, 131));padding:1px;border-bottom: 1px solid white;border-top: 2px solid rgb(35, 85, 131);box-shadow:0px 0px 10px 1px white;margin-top:5px;">
	<div class ="logo"></div>
	<div class ="logo1"></div>
...
<table style=";width:100%;border-spacing: 0;" border="0">
	...
	<tr class ="tools" style = "background-color:rgb(105, 123, 130);">
		...
		<td style ="width:1%;background-color:rgb(34, 59, 94);">
			<table>
				<tr>
					
					<td style ="padding:0px 10px;"><input type ="button" style ="border:1px solid white;cursor:pointer;font-size:10px;" onclick ="reset()" value ="RESET"/></td>
				</tr>
			</table>
		</td>
	</tr>
	<tr class ="tools">
		<td colspan="100%" style ="background-color:rgb(46, 62, 82);width:100%;">
			...
			<table style="border-spacing: 0;" id ="percentageTable">
				<tr>
					<td>
					...
					<td style ="padding-left:20px;">
						<table id = "poTablePercentage" style ="color:white;border-spacing;font-size:12px;font-size: 16px;background-color:rgb(0, 0, 0);">
							<tr style = "color:silver;">
