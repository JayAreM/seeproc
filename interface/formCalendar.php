<?php
    ...
    $sql = "SELECT TrackingNumber, Claimant, TrackingType, DocumentType, Status, Amount, PO_Amount, TotalAmountMultiple, DateModified, Office, Name, Complex
            ...
            <table border="0" style="margin-top:30px; width:100%; border-spacing:0px;">
                ...
                <tr>
                    ...
                    <td style="vertical-align:top;">
                        ...
                        <div style="font-size:12px;"><?= $dataModified ?></div>
                    </td>
                </tr>
