...
<table style="background-color: white;width:100%;height:100%;margin:0;border-spacing:0" border="0">
	<tr>
		<td style="vertical-align: top;">
			<div id = "infraPhase3Container" >
			</div>
		</td>
	</tr>
	<tr id ="footerPhase3Infra">
...
<script>
	...
	function showPhase3(){
		var queryString = "?showInfraPhase1=3";
		var container = document.getElementById('infraPhase3Container');			
		loader();
	...
	function detect(){
		if(document.getElementById("panelContainer1")){
			document.getElementById("footerPhase3Infra").style.display = "none";
		}else{
			showPhase3();
		}
	}
