<?php
	...
	$sql ="select Name,FundYear,Lump from programcode where TrackingNumberInfra = '"  . $trackingNumber. "' limit 1";
	$record =$database->query($sql);
	$data =$database->fetch_array($record);
						...
						<tr >
							<td style="font-size:15px;text-align: justify;">
								...
								<p style ="text-indent: 50px;">This is to certify that the appropriation of <b><?php echo ucwords($amountWords);?> (P<?php echo number_format($amount,2); ?>)</b>
								 is available under <?php echo $fundDescription; ?> ADF, CY<?php echo $fundYear;?>, for the <b><?php echo $description; ?></b><?php echo $projectCode ?></p>
