...
<script>
	...
	function loadSummary(){
		...
		loader();
		ajaxGetAndConcatenate(queryString,processorLink,container,"loadSummaryOffice");	
	}
	var p1Prog;
	var p2Des;
	var p3Prog;
	...
	function clickTR(me){
		...
		var queryString = "?loadBalanceByProgramOffice=1&program=" + me.id + "&period=" + period + "&periodDay=" + day +  "&periodYear=" + year + "&periodMonth=" + month ;
	...
	function clickTRAcct(me){
		...
		var queryString = "?loadBalanceByAccountOffice=1&accountCode=" + accountCode + "&program=" + program + "&period=" + period + "&periodDay=" + day +  "&periodYear=" + year + "&periodMonth=" + month ;
